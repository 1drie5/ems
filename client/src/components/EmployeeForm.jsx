...
const EmployeeForm = ({initialData, onSuccess, onCancel}) => {
    ...
    <form onSubmit={handleSubmit} className='space-y-6 max-w-3xl animate-fade-in'>
        ...
        {/* employment details */}
        <div className='card p-5 sm:p-6'>
            <h3 className='text-base font-medium text-slate-900 mb-6 pb-4 border-b border-slate-100'>Employement Details</h3>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                <div>
        ...
        <div className='flex flex-col-reverse sm:flex-row justify-end gap-3 pt-2'>
            <button type='button' className='btn-secondary' onClick={() => (onCancel ? onCancel() : navigate("/employees"))}>Cancel</button>
