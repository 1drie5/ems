    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if(!data.success) throw new Error(data.error || "Failed")
                setMessage({ type: "success", text: "Password updated sucessfully" })
        ...
        <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-md animate-fade-in' onClick={(e)=>e.stopPropagation()}>
            ...
            <form className='p-6 space-y-5' onSubmit={handleSubmit}>
                ...
                <div className='flex gap-3 pt-2'>
                    ...
                    <button type="submit" disabled={loading} className='btn-primary flex-1 flex justify-center gap-2'>{loading && <Loader2Icon className='w-4 h-4 animate-spin' />}Update Password</button>
                </div>
